// Icon set — stroke-based, 1.75 weight, rounded. Ported verbatim from the
// prototype's icons.jsx. Custom shield-check logo mark handled specially.
...
export type IconName = keyof typeof ICON_PATHS | 'logo';
